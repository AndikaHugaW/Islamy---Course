...
<body>
  ...
  <nav class="bg-white" style="position: -webkit-sticky; position: sticky; top: 0; background-color: white; z-index: 1000; box-shadow: 0 4px 8px rgba(0, 0, 1, 0.384); padding: 26px 26px 26px 26px;">
      ...
      <div class="flex justify-between h-16">
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8" style="margin-left: -50px;">
            <a href="/home" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">Home</a>
            <a href="/courses" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">Courses</a>
            <a href="/blog" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">Blog</a>
            <a href="/contact" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">Contact</a>
          </div>
          @elseif(Auth::check() && Auth::user()->role == 'admin')
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8" style="margin-left: -50px;">
            <a href="{{ route('courseadmin') }}" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">Courses</a>
            <a href="{{ route('user') }}" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">User</a>
          </div>
          @else
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8" style="margin-left: -50px;">
            <a href="/home" class="text-gray-500 hover:text-blue-500 inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-blue-500 text-lg hover:text-xl hover:font-bold font-semibold">Home</a>

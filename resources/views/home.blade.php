          ...
          <div class="grid grid-cols-1 lg:h-screen lg:grid-cols-2">
            ...
            <div class="relative flex items-center ">
              ...
              <div class="p-8 sm:p-16 lg:p-20">
                ...
                <ul class="max-w-md mt-10 space-y-1 text-gray-500 list-inside">
                    <li class="flex items-center">
                        <svg class="w-8 h-8 me-2 text-green-500 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section>
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <header class="text-center">
            <h2 class="text-xl font-bold text-gray-900 sm:text-3xl">Explore Kursus Terbaik Untuk Kamu</h2>
        ...
        <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
            <span class="relative inline-block">
              ...
              <span class="relative">Dapatkan</span>
            </span>
            Juga Berita Terkini Tentang Islam
          </h2>
        ...
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            ...
            <article class="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                ...
                <div class="bg-white p-4 sm:p-6">
                  ...
                  <a href="#">
                    <h3 class="mt-0.5 text-lg font-semibold text-gray-900">Kondisi Palestina Terkini</h3>
                  </a>
            ...
            <article class="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                ...
                <div class="bg-white p-4 sm:p-6">
                  ...
                  <a href="#">
                    <h3 class="mt-0.5 text-lg font-semibold text-gray-900">Viral Aksi Boikot Produk Israel</h3>
                  </a>
            ...
            <article class="overflow-hidden rounded-lg shadow transition hover:shadow-lg">
                ...
                <div class="bg-white p-4 sm:p-6">
                  ...
                  <a href="#">
                    <h3 class="mt-0.5 text-lg font-semibold text-gray-900">Angka Kematian Jamaah Haji 2024</h3>
                  </a>
